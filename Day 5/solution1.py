...
for line in inputText:
    if "move" in line:
        ...
        # Long line, but basically takes the last X characters of the first crate, reverses them and appends them to the second crate
        crates[moves[2]-1] += crates[moves[1]-1][moves[0]*(-1):][::-1]
